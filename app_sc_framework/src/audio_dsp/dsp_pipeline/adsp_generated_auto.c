...
void dsp_auto_thread0(chanend_t* c_source, chanend_t* c_dest, module_instance_t** modules) {
	...
	int32_t edge9[1] = {0};
	int32_t edge10[1] = {0};
	int32_t* stage_2_input[] = {edge0};
	int32_t* stage_2_output[] = {edge2, edge3};
	int32_t* stage_3_input[] = {edge1};
	int32_t* stage_3_output[] = {edge4};
	int32_t* stage_4_input[] = {edge2, edge3};
	int32_t* stage_4_output[] = {edge8, edge9};
	int32_t* stage_5_input[] = {edge4};
	int32_t* stage_5_output[] = {edge5, edge6};
	int32_t* stage_6_input[] = {edge6};
	int32_t** stage_6_output = NULL;
	int32_t* stage_7_input[] = {edge5};
	int32_t* stage_7_output[] = {edge7};
	int32_t* stage_8_input[] = {edge7};
	...
	SELECT_RES(
		...
		envelope_detector_rms_control(modules[6]->state, &modules[6]->control);
		cascaded_biquads_control(modules[7]->state, &modules[7]->control);
		noise_gate_control(modules[8]->state, &modules[8]->control);
		control_done = true;
...
void dsp_auto_thread1(chanend_t* c_source, chanend_t* c_dest, module_instance_t** modules) {
	...
	int32_t* stage_1_output[] = {edge3, edge4, edge5, edge6};
	int32_t* stage_2_input[] = {edge0, edge3};
	int32_t* stage_2_output[] = {edge7};
	int32_t* stage_3_input[] = {edge1, edge4};
	int32_t* stage_3_output[] = {edge8};
	int32_t* stage_4_input[] = {edge7, edge8};
	int32_t* stage_4_output[] = {edge9, edge10, edge11, edge12};
	int32_t* stage_5_input[] = {edge9, edge10};
	int32_t* stage_5_output[] = {edge13};
	int32_t* stage_6_input[] = {edge11, edge12};
	int32_t* stage_6_output[] = {edge16, edge20};
	int32_t* stage_7_input[] = {edge13, edge5};
	int32_t* stage_7_output[] = {edge14};
	int32_t* stage_8_input[] = {edge16};
	int32_t* stage_8_output[] = {edge19, edge17};
	int32_t* stage_9_input[] = {edge14, edge6};
	int32_t* stage_9_output[] = {edge15};
	int32_t* stage_10_input[] = {edge17};
	int32_t** stage_10_output = NULL;
	int32_t* stage_11_input[] = {edge15};
	int32_t* stage_11_output[] = {edge18};
	uint32_t start_ts, end_ts, start_control_ts, control_ticks;
	bool control_done;
	while(1) {
	control_done = false;
	...
	SELECT_RES(
		...
		mixer_control(modules[5]->state, &modules[5]->control);
		volume_control_control(modules[6]->state, &modules[6]->control);
		switch_control(modules[9]->state, &modules[9]->control);
		envelope_detector_rms_control(modules[10]->state, &modules[10]->control);
...
adsp_pipeline_t * adsp_auto_pipeline_init() {
	...
	static module_instance_t adsp_auto_modules[21];
	...
	adsp_auto.n_modules = 21;
	static pipeline_config_t config0 = { .checksum = {59, 204, 83, 227, 252, 70, 143, 105, 62, 156, 132, 174, 124, 10, 8, 110} };
	...
	static dsp_thread_config_t config1 = {  };
            ...
            static fork_state_t state2;
            static uint8_t memory2[_ADSP_MAX(1, FORK_REQUIRED_MEMORY(1, 2, 1))];
            ...
            adsp_auto.modules[2].control.config_rw_state = config_none_pending;
                ...
                fork_init(&adsp_auto.modules[2], &allocator2, 2, 1, 2, 1);
	static volume_control_config_t config3 = { .target_gain = 134217728, .slew_shift = 7, .mute = 0 };

            static volume_control_state_t state3;
            static uint8_t memory3[_ADSP_MAX(1, VOLUME_CONTROL_REQUIRED_MEMORY(1, 1, 1))];
	...
	static volume_control_config_t config4 = { .target_gain = 134217728, .slew_shift = 7, .mute = 0 };
            ...
            static uint8_t memory4[_ADSP_MAX(1, VOLUME_CONTROL_REQUIRED_MEMORY(2, 2, 1))];
            ...
            static uint8_t memory5[_ADSP_MAX(1, FORK_REQUIRED_MEMORY(1, 2, 1))];
	...
	static envelope_detector_rms_config_t config6 = { .attack_alpha = 298262, .release_alpha = 298262 };

            static envelope_detector_rms_state_t state6;
            static uint8_t memory6[_ADSP_MAX(1, ENVELOPE_DETECTOR_RMS_REQUIRED_MEMORY(1, 0, 1))];
            ...
            adsp_auto.modules[6].control.config_rw_state = config_none_pending;
                ...
                adsp_auto.modules[6].control.module_type = e_dsp_stage_envelope_detector_rms;
                adsp_auto.modules[6].control.num_control_commands = NUM_CMDS_ENVELOPE_DETECTOR_RMS;
                envelope_detector_rms_init(&adsp_auto.modules[6], &allocator6, 6, 1, 0, 1);
	static cascaded_biquads_config_t config7 = { .left_shift = {0, 0, 0, 0, 0, 0, 0, 0}, .filter_coeffs = {1068783281, -2137566562, 1068783281, 2137543670, -1063847630, 1073741824, 0, 0, 0, 0, 1073741824, 0, 0, 0, 0, 1073741824, 0, 0, 0, 0, 1073741824, 0, 0, 0, 0, 1073741824, 0, 0, 0, 0, 1073741824, 0, 0, 0, 0, 1073741824, 0, 0, 0, 0} };

            static cascaded_biquads_state_t state7;
            static uint8_t memory7[_ADSP_MAX(1, CASCADED_BIQUADS_REQUIRED_MEMORY(1, 1, 1))];
            ...
            adsp_auto.modules[7].control.config_rw_state = config_none_pending;
                ...
                adsp_auto.modules[7].control.module_type = e_dsp_stage_cascaded_biquads;
                adsp_auto.modules[7].control.num_control_commands = NUM_CMDS_CASCADED_BIQUADS;
                cascaded_biquads_init(&adsp_auto.modules[7], &allocator7, 7, 1, 1, 1);
	static noise_gate_config_t config8 = { .attack_alpha = 17895697, .release_alpha = 745654, .threshold = 4244337 };

            static noise_gate_state_t state8;
            static uint8_t memory8[_ADSP_MAX(1, NOISE_GATE_REQUIRED_MEMORY(1, 1, 1))];
            ...
            adsp_auto.modules[8].control.config_rw_state = config_none_pending;
                ...
                adsp_auto.modules[8].control.module_type = e_dsp_stage_noise_gate;
                adsp_auto.modules[8].control.num_control_commands = NUM_CMDS_NOISE_GATE;
                noise_gate_init(&adsp_auto.modules[8], &allocator8, 8, 1, 1, 1);
	static dsp_thread_config_t config9 = {  };

            static dsp_thread_state_t state9;
            static uint8_t memory9[_ADSP_MAX(1, DSP_THREAD_REQUIRED_MEMORY(0, 0, 1))];
            ...
            adsp_auto.modules[9].control.config_rw_state = config_none_pending;
                ...
                adsp_auto.modules[9].control.module_type = e_dsp_stage_dsp_thread;
                adsp_auto.modules[9].control.num_control_commands = NUM_CMDS_DSP_THREAD;
                dsp_thread_init(&adsp_auto.modules[9], &allocator9, 9, 0, 0, 1);

            static fork_state_t state10;
            static uint8_t memory10[_ADSP_MAX(1, FORK_REQUIRED_MEMORY(1, 4, 1))];
            ...
            adsp_auto.modules[10].control.config_rw_state = config_none_pending;
                ...
                fork_init(&adsp_auto.modules[10], &allocator10, 10, 1, 4, 1);
	static compressor_sidechain_config_t config11 = { .attack_alpha = 8947849, .release_alpha = 178957, .threshold = 134217, .slope = 0.4 };

            static compressor_sidechain_state_t state11;
            static uint8_t memory11[_ADSP_MAX(1, COMPRESSOR_SIDECHAIN_REQUIRED_MEMORY(2, 1, 1))];
            ...
            adsp_auto.modules[11].control.config_rw_state = config_none_pending;
                ...
                adsp_auto.modules[11].control.module_type = e_dsp_stage_compressor_sidechain;
                adsp_auto.modules[11].control.num_control_commands = NUM_CMDS_COMPRESSOR_SIDECHAIN;
                compressor_sidechain_init(&adsp_auto.modules[11], &allocator11, 11, 2, 1, 1);
	static compressor_sidechain_config_t config12 = { .attack_alpha = 8947849, .release_alpha = 178957, .threshold = 134217, .slope = 0.4 };
            ...
            static uint8_t memory13[_ADSP_MAX(1, FORK_REQUIRED_MEMORY(2, 4, 1))];
            ...
            adsp_auto.modules[13].control.config_rw_state = config_none_pending;
                ...
                fork_init(&adsp_auto.modules[13], &allocator13, 13, 2, 4, 1);
	static mixer_config_t config14 = { .gain = 67268211 };

            static mixer_state_t state14;
            static uint8_t memory14[_ADSP_MAX(1, MIXER_REQUIRED_MEMORY(2, 1, 1))];
            ...
            adsp_auto.modules[14].control.config_rw_state = config_none_pending;
                ...
                adsp_auto.modules[14].control.module_type = e_dsp_stage_mixer;
                adsp_auto.modules[14].control.num_control_commands = NUM_CMDS_MIXER;
                mixer_init(&adsp_auto.modules[14], &allocator14, 14, 2, 1, 1);
	static volume_control_config_t config17 = { .target_gain = 134217728, .slew_shift = 7, .mute = 0 };

            static volume_control_state_t state17;
            static uint8_t memory17[_ADSP_MAX(1, VOLUME_CONTROL_REQUIRED_MEMORY(2, 2, 1))];
            ...
            adsp_auto.modules[17].control.config_rw_state = config_none_pending;
                ...
                adsp_auto.modules[17].control.module_type = e_dsp_stage_volume_control;
                adsp_auto.modules[17].control.num_control_commands = NUM_CMDS_VOLUME_CONTROL;
                volume_control_init(&adsp_auto.modules[17], &allocator17, 17, 2, 2, 1);
            ...
            static uint8_t memory19[_ADSP_MAX(1, FORK_REQUIRED_MEMORY(1, 2, 1))];
            ...
            adsp_auto.modules[19].control.config_rw_state = config_none_pending;
                ...
                fork_init(&adsp_auto.modules[19], &allocator19, 19, 1, 2, 1);
	...
	static envelope_detector_rms_config_t config20 = { .attack_alpha = 298262, .release_alpha = 298262 };

            static envelope_detector_rms_state_t state20;
            static uint8_t memory20[_ADSP_MAX(1, ENVELOPE_DETECTOR_RMS_REQUIRED_MEMORY(1, 0, 1))];
            ...
            adsp_auto.modules[20].control.config_rw_state = config_none_pending;
                ...
                adsp_auto.modules[20].control.module_type = e_dsp_stage_envelope_detector_rms;
                adsp_auto.modules[20].control.num_control_commands = NUM_CMDS_ENVELOPE_DETECTOR_RMS;
                envelope_detector_rms_init(&adsp_auto.modules[20], &allocator20, 20, 1, 0, 1);
	static volume_control_config_t config18 = { .target_gain = 134217728, .slew_shift = 7, .mute = 0 };

            static volume_control_state_t state18;
            static uint8_t memory18[_ADSP_MAX(1, VOLUME_CONTROL_REQUIRED_MEMORY(1, 1, 1))];
            ...
            adsp_auto.modules[18].control.config_rw_state = config_none_pending;
                ...
                adsp_auto.modules[18].control.module_type = e_dsp_stage_volume_control;
                adsp_auto.modules[18].control.num_control_commands = NUM_CMDS_VOLUME_CONTROL;
                volume_control_init(&adsp_auto.modules[18], &allocator18, 18, 1, 1, 1);
	return &adsp_auto;
}
